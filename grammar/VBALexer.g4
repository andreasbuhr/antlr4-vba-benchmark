/*
* copied to andreasbuhr/antlr4-vba-benchmark from https://github.com/rubberduck-vba/Rubberduck/blob/next/Rubberduck.Parsing/Grammar/VBALexer.g4
*
...
fragment WS_NOT_FOLLOWED_BY_LINE_CONTINUATION : [ \t];
